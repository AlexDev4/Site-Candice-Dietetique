                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="#">
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img src="<?= $this->Url->build('/assets/images/portrait/small/avatar-s-15.jpg'); ?>" alt="avatar" width="32" height="32"></div>
                                    </div>
                                ...
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">
                                        <div class="avatar"><img src="<?= $this->Url->build('/assets/images/portrait/small/avatar-s-3.jpg'); ?>" alt="avatar" width="32" height="32"></div>
                                    </div>
                                    <div class="list-item-body flex-grow-1">
                        ...
                        <li class="dropdown-menu-footer"><a class="btn btn-primary w-100" href="#">Voir toutes les notifications</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder"><?= $this->Identity->get('prenom') ?> <?= $this->Identity->get('nom') ?></span><span class="user-status">Administrateur</span></div><span class="avatar"><img class="round" src="<?= $this->Url->build('/assets/images/portrait/small/avatar-s-11.jpg'); ?>" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                <div class="d-flex align-items-center">
                    <div class="avatar me-75"><img src="<?= $this->Url->build('/assets/images/portrait/small/avatar-s-8.jpg'); ?>" alt="png" height="32"></div>
                    <div class="search-data">
