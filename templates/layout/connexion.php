...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= $this->Url->build('/bo/assets/css/plugins/forms/form-validation.css')?>">
    <link rel="stylesheet" type="text/css" href="<?= $this->Url->build('/bo/assets/css/pages/authentication.css')?>">
    <link rel="stylesheet" type="text/css" href="<?= $this->Url->build('/bo/css/custom.css')?>">
