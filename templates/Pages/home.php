...
<section id="slider" class="slider-element boxed-slider">
    ...
    <div class="container clearfix">
        <div class="img-pages-presta">
            <img class="img-presta" src="img/panier-legumes.png" alt="perte de poids">
            <h1>Candice Vivian-Latil</h1>
            <h1>votre diététicienne-nutritionniste à Saint Cyr sur Mer</h1>
        </div>
    </div>
        ...
        <div class="content">
            <div class="container clearfix">
                <div class="row">
                    ...
                    <div class="col-6">
                        <img class="img-cabinet"src="img/interieur-cabinet.png"
                            alt="interieur-cabinet-Saint-Cyr-Sur-Mer">
                    </div>
                </div>
